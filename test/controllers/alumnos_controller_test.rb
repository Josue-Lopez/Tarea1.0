...
class AlumnosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create alumno" do
    assert_difference('Alumno.count') do
      post alumnos_url, params: { alumno: { carrera: @alumno.carrera, cuenta: @alumno.cuenta, direccion: @alumno.direccion, edad: @alumno.edad, identidad: @alumno.identidad, nombre: @alumno.nombre } }
    end
  ...
  test "should update alumno" do
    patch alumno_url(@alumno), params: { alumno: { carrera: @alumno.carrera, cuenta: @alumno.cuenta, direccion: @alumno.direccion, edad: @alumno.edad, identidad: @alumno.identidad, nombre: @alumno.nombre } }
